		...
		<script type="text/javascript">
			...
			function mainPost() {// 載入資料完，未 refresh 前
				...
				switch(q_getPara('sys.project').toUpperCase()){
					case 'RK':
						//聯琦 採購小數位沒有限制,進貨也一樣
						bbsNum = [['txtTotal', 12, 2, 1], ['txtTotalus', 12, 2, 1], ['txtMount', 10, 2, 1], ['txtWeight', 10, 2, 1], ['txtGweight', 10, 2, 1], ['txtTheory', 10, 3, 1], ['textSize1', 10, 3, 1], ['textSize2', 10, 2, 1], ['textSize3', 10, 3, 1], ['textSize4', 10, 2, 1]];
						...
						break;
					default:
						bbsNum = [['txtPrice', 15, 3, 1],['txtPriceus', 15, 4, 1], ['txtTotal', 12, 2, 1], ['txtTotalus', 12, 2, 1], ['txtMount', 10, 2, 1], ['txtWeight', 10, 2, 1], ['txtGweight', 10, 2, 1], ['txtTheory', 10, 3, 1], ['textSize1', 10, 3, 1], ['textSize2', 10, 2, 1], ['textSize3', 10, 3, 1], ['textSize4', 10, 2, 1]];
						break;
				}
			...
			function q_gtPost(t_name) {/// 資料下載後 ...
                switch (t_name) {
                    case 'rc2e_import':
                        ...
                        q_gridAddRow(bbsHtm, 'tbbs', 'txtStoreno,txtStore,txtOrdeno,txtNo2,txtUno,txtProductno,txtProduct,txtStyle,txtSpec,txtWidth,txtDime,txtLengthb,txtWeight,txtGweight,txtClass,txtWidth2,txtSize,txtMount,txtUnit', as.length, as,
						'Storeno,Store,Ordeno,No2,Uno,Productno,Product,Style,Spec,Width,Dime,Lengthb,Weight,Gweight,Class,Width2,Size,Mount,Unit');
                		break;
					case 'isinvosystem':
			...
			<div class="dbbm">
				<table class="tbbm"  id="tbbm">
					...
					<tr>
						...
						<td><input id="btnRc2e" type="button" value="發貨匯入" /></td>
					</tr>
					<tr>
		...
		<div class='dbbs'>
			<table id="tbbs" class='tbbs' style=' text-align:center'>
				<tr style='color:white; background:#003366;' >
					...
					<td align="center"><a id='lblMemos_st'> </a><br><a id='lblCert_st' style="display:none;"> </a></td>
				</tr>
				...
				<tr style='background:#cad3ff;'>
					...
					<td class="RK_hide"><input id="txtWidth2.*" type="text" style="width:95%;"/></td>
					...
					<td><input id="txtMemo.*" type="text" style="width:95%;"/><!---<input id="btnCert.*" class="btnCert" type="button" style="width:95%;"/>---></td>
				</tr>
			</table>
		</div>
